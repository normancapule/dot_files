...
(defun setup-indent (n)
  ...
  (setq-default react-indent-level n) ; react-mode
  (setq-default js2-basic-offset n) ; js2-mode, in latest js2-mode, it's alias of js-indent-level
  (setq-default web-mode-attr-indent-offset n) ; web-mode
  ...
  (setq-default web-mode-sql-indent-offset n) ; web-mode
  (setq-default web-mode-attr-value-indent-offset n) ; web-mode
  (setq-default css-indent-offset n) ; css-mode
  (setq-default sh-basic-offset n) ; shell scripts
  (setq-default sh-indentation n)
  (add-hook 'after-change-major-mode-hook (lambda() (electric-indent-mode -1)))
  (setq-default electric-indent-mode 0)
  ;; https://github.com/syl20bnr/spacemacs/issues/8897
...
before packages are loaded."
  ...
  (define-key evil-normal-state-map (kbd "+") 'spacemacs/toggle-maximize-buffer)
  (define-key evil-normal-state-map (kbd "SPC n") 'treemacs-find-file)
  ...
  (define-key evil-normal-state-map (kbd "SPC >>") 'org-do-demote)
